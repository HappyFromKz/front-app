<template>
  <DataTable :value="categories" tableStyle="min-width: 50rem">
    ...
    <Column field="category" header="Actions">
      <template #body="{data}">
        <Button @click="openModal('Update', data.id)" style="margin-right: 20px;"
                type="button" class="p-button-success mx-2">Change</Button>
        <Button @click="deleteCategory(data.id)" type="button" class="p-button-danger">Delete</Button>
      </template>
    </Column>
  </DataTable>
